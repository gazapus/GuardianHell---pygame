...
class Level4(Level):
     ...
     def initialize(self, window, *others):
          ...
          pygame.time.set_timer(self.NEW_BASIC_SOUL, 2000)
          pygame.time.set_timer(self.NEW_BASIC_SOUL2, 2600)
          pygame.time.set_timer(self.NEW_BOUNCE_SOUL, 7000)
          pygame.time.set_timer(self.NEW_FIREBALL, 3000)
          pygame.time.set_timer(self.NEW_SUPER_FIREBALL, 7000)
          pygame.time.set_timer(self.NEW_COIN, 2500)
          pygame.time.set_timer(self.NEW_LIVE, 8000)
